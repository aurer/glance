...
const formSchema = z.object({
  coin: z.string().min(1, "Coin name is required"),
  ...
  return (
    <Dialog open={editor !== null} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>{mode === "add" ? "Add a Coin" : "Edit " + editor?.coin.coin}</DialogTitle>
          <DialogDescription>
            {mode === "add" ? "Add a coin to your portfolio" : "Edit the details of a coin in your portfolio"}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
